...
# character details
pr_sex = "Sex: " + char_sex
pr_appearance = "Appearance: " + physical_description
pr_detail = "Detail: " + physical_detail
pr_background = "Background: " + background
pr_clothing = "Clothing: " + clothing
pr_personality = "Personality: " + personality
pr_mannerism = "Mannerism: " + mannerism
...
if rand_class == "Human":
    ...
    print "\n"
    pr_name = char_name.upper(), "THE", rand_human_prof[0].upper()
    print pr_name
...
if rand_class == "Mutant":
    ...
    print "\n"
    pr_name = char_name.upper() + " THE MUTANT"
    print pr_name

    pr_sex = "Sex: " + random.choice(
...
if rand_class == "Robot":
    ...
    # print their stats and abilities
    print "\n"
    pr_name = char_name.upper() + " THE ROBOT"
    print pr_name
    print "Sex:", char_sex
...
if rand_class == "Psionic":
    ...
    pr_name = char_name.upper() + " THE PSIONIC"
    print pr_name
...
if rand_class == "Warrior":
    ...
    pr_name = char_name.upper(),"THE WARRIOR"
    print pr_name
...
if rand_class == "Thief":
    ...
    pr_name = char_name.upper() + " THE THIEF"
    print pr_name
...
if rand_class == "Cleric":
    print "\n"
    pr_name = char_name.upper() + " THE CLERIC"
    print pr_name
...
if rand_class == "Conjurer":
    ...
    pr_name = char_name.upper() + " THE CONJURER"
...
if rand_class == "Maze Rat":
    outfile = open("maze_rat_char.txt", "w")

    pr_name = char_name.upper() + " THE MAZE RAT"
    ...
    # print their stats and abilities
    hp = rolldN(6) + 4 + extrahp
    pr_hp = "HP:" + str(hp)
    pr_hp_rest = "HP per level/Resting: d6"

    pr_proficiency = "Weapons & Armor: " + weaponprof + shieldprof + armorprof
    pr_damage = "Attack Damage: 1d6 if armed, 1d4 if unarmed or improvising"
...
print pr_background
print pr_clothing
print pr_personality
print pr_mannerism
print ""
print pr_hp
print pr_hp_rest
print pr_proficiency
print pr_damage

outfile.write("{0} THE MAZE RAT\n".format(char_name.upper()))
outfile.write("Sex: {0}\n".format(char_sex))
outfile.close()
